# biogen_splicing_pipeline_mry_alltools_v3_hg38.py
import argparse
import datetime
import os
import sys
...
parser.add_argument('--leafcutter_covar', help="Include this flag to include a leafcutter covariate file", default=False, action='store_true')
...
-rwxrwxr-x 1 tgomez1   tgomez1    7677 May 17  2022 01_parsing_outputs_example_tg.R
drwxrwxr-x 4 mryals    mryals     1460 Jun 22  2022 archived
-rwxrwxr-x 1 mryals    mryals      520 Jun 18  2021 bam_fastqc.sh
-rwxrwxr-x 1 mryals    mryals      551 Jun 17  2021 bam_flagstat.sh
-rwxrwxr-x 1 mryals    mryals      341 Jul 14  2021 bam_multiqc.sh
drwxrwxr-x 2 mryals    mryals      249 Jun 21  2021 BIO-0103001
drwxrwxr-x 2 mryals    mryals      249 Jun 24  2021 BIO-0543659
drwxrwxr-x 2 mryals    mryals      249 Jun 25  2021 BIO-0550637

drwxrwxr-x 2 583343508 583343508   249 Jul  1  2021 BIO-2040024
-rwxrwxr-x 1 mryals    mryals    23322 Jun 27  2022 biogen_splicing_pipeline_mry_alltools_v3_hg38.py
-rwxrwxr-x 1 mryals    mryals    25281 Nov  2  2021 biogen_splicing_pipeline_mry_alltools_v3_majiqbuild.py
-rwxrwxr-x 1 mryals    mryals    23322 Jun 24  2021 biogen_splicing_pipeline_mry_alltools_v3.py
drwxrwxr-x 2 mryals    mryals      262 Jun  3  2022 CATEGORIES
drwsrwxr-x 6 583288326 583288326   156 Mar  1  2021 example_codes
drwxrwxr-x 2 583343508 583343508    68 Sep 10  2021 example_visualization
-rwxrwxr-x 1 mryals    mryals     4469 Jul 12  2021 gtf2gff3_rtracklayer.R
-rwxrwxr-x 1 mryals    mryals      534 Jun 23  2021 leafcutter_annot.sh
-rwxrwxr-x 1 mryals    mryals    12496 Nov 19  2021 leafcutter_categories_missing.R
-rwxrwxr-x 1 mryals    mryals    13007 Nov 30  2021 leafcutter_categories_missing_v2.R
-rwxrwxr-x 1 mryals    mryals    11159 Feb  7  2022 leafcutter_categories.R
-rwxrwxr-x 1 mryals    mryals      201 Nov  5  2021 leafcutter_categories.sh
-rwxrwxr-x 1 tgomez1   tgomez1   11250 May  2  2022 leafcutter_categories_tg.R
-rwxrwxr-x 1 mryals    mryals      785 Jun 23  2021 leafcutterviz_annotation.R
-rwxrwxr-x 1 mryals      1000515 12280 Feb  9  2022 majiq_categories.R
-rwxrwxr-x 1 mryals    mryals      206 Feb  9  2022 majiq_categories.sh
-rwxrwxr-x 1 tgomez1   tgomez1   12779 Mar 30  2022 majiq_categories_tg.R
-rwxrwxr-x 1 mryals    mryals     2846 Sep 22  2021 make_db.R
-rwxrwxr-x 1 mryals    mryals     2745 Jul 15  2021 make_folders.sh
-rwxrwxr-x 1 mryals    mryals    11939 May 25  2021 make_master_table_v2.R
-rwxrwxr-x 1 mryals    mryals     4999 Sep  7  2021 make_test_db.R
-rwxrwxr-x 1 mryals    mryals    11039 May 13  2022 rmats_categories_tg_mry.R
-rwxrwxr-x 1 tgomez1   tgomez1   11047 May 30  2022 rmats_categories_tg.R
-rwxrwx--- 1 583343507 583343507  1085 Aug 13  2021 run_leafviz_mry_v2_mgp.R
-rwxrwxr-x 1 mryals    mryals      959 Aug  9  2021 run_leafviz_mry_v2.R
-rwxrwxr-x 1 tgomez1   tgomez1   21888 May  4  2022 sashimi.R
-rwxrwxr-x 1 tgomez1   tgomez1    3647 Jun  2  2022 sashimi_tG_01.R
-rwxrwxr-x 1 tgomez1   tgomez1    4788 May  6  2022 sashimi_tG.R
-rwxrwxr-x 1 mryals    mryals      282 Sep 10  2021 submit_make_db.sh
-rwxrwxr-x 1 mryals    mryals      989 Jul 21  2021 submit_shells_leafcutter_mry.sh
-rwxrwxr-x 1 583343507 583343507  1048 Jul 19  2021 submit_shells_majiq_mgp.sh
-rwxrwxr-x 1 mryals    mryals      964 Jul 21  2021 submit_shells_majiq_mry.sh
-rwxrwxr-x 1 583343507 583343507   308 Jul 22  2021 submit_shells_master_table_mgp.sh
-rwxrwxr-x 1 mryals    mryals      984 Jul 27  2021 submit_shells_master_table_mry.sh
-rwxrwxr-x 1 mryals    mryals      964 Jul 21  2021 submit_shells_rmats_mry.sh
-rwxrwxr-x 1 mryals    mryals    31602 Sep 17  2021 summary_global_splicing_res.R
-rwxrwxr-x 1 mryals    mryals     1711 Jul 11  2022 test_hg38_qsub_majiq.sh
-rwxrwxr-x 1 mryals    mryals     2708 Nov  2  2021 test_majiqdeltapsi_BIO-0103001_argparse_wrapper_qsub_majiq.sh
-rwxrwxr-x 1 mryals    mryals     1596 Oct 31  2021 test_new_qsub_argparse_wrapper_qsub_leafcutter.sh
-rwxrwxr-x 1 tgomez1   tgomez1   17125 Apr 19  2022 test_rmats.R
-rwxrwxr-x 1 tgomez1   tgomez1    2512 Jun  1  2022 trio_functions_tg.R
-rwxrwxr-x 1 tgomez1   tgomez1    9367 May 19  2022 trio_GR_firstattempt_tg.R
-rwxrwxr-x 1 tgomez1   tgomez1   11560 Jun  2  2022 trio_GR_tg_v2.R
drwxrwxrwx 3 tgomez1   tgomez1    1552 Nov 21  2022 Trio_harmoniz
-rwxrwxr-x 1 mryals    mryals    10813 May 18  2022 trio_summ_categories_mry.R
-rwxrwxr-x 1 tgomez1   tgomez1   36118 Jun  2  2022 utils_sashimi.R
-rwxrwxr-x 1 tgomez1   tgomez1   39508 Jun 20  2022 utils_sashimi_v2.R
-rwxrwxr-x 1 tgomez1   tgomez1   45454 Jul  4  2022 utils_sashimi_v34R.R
-rwxrwxr-x 1 tgomez1   tgomez1   44768 Jul  5  2022 utils_sashimi_v3.R
-rwxrwxr-x 1 tgomez1   tgomez1   45454 Jul  4  2022 utils_sashimi_v4.R
-rwxrwxr-x 1 tgomez1   tgomez1   42891 Jul  5  2022 utils_sashimi_v5.R
